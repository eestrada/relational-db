...
*/
int Fighter::getMaximumHP(){return this->maxhp;}
...
*/
int Fighter::getCurrentHP(){return this->curhp;}
...
*/
int Fighter::getStrength(){return this->strength;}
...
*/
int Fighter::getMagic(){return this->magic;}
...
*/
int Fighter::getDamage(){return this->strength;}
...
{
	int tmpdamage = damage - (this->speed / 4);
	tmpdamage = (tmpdamage < 1) ? 1 : tmpdamage;
    this->curhp -= tmpdamage;
}
...
{
    int tmphp = (double)this->strength / 6.0;
    tmphp = (tmphp < 1) ? 1 : tmphp;
    this->curhp += tmphp;
...
*/
bool Fighter::useAbility(){return false;}
...
*/
bool Fighter::isSimplified(){return false;}
