...
myDelay2		.equ	7125				; set delay2 constant
delay1second	.equ	4
delay5seconds	.equ	5
...
sixSecondToggle:
			mov.w	#toggle6seconds,r11		; make R12 a counter to toggle the light for six seconds (one second between each toggle)
...
fourSecondToggle:
			mov.w	#toggle4seconds,r11		; make R12 a counter to toggle the light for four seconds (1/4 second between each toggle)
...
tenSecondsOff:
			call	#toggleLight			; call subroutine "toggleLight"
			mov.w	#delay10seconds,r11		; make R12 a counter to count down ten seconds
