...
getSwitch:
        ...
        cmp.w	#1,r5					; check if P2.0 has been tripped
          jeq	switchPress_1			; yes!
        cmp.w	#2,r5					; check if P2.1 has been tripped
          jeq	switchPress_2			; yes!
        cmp.w	#4,r5					; check if P2.2 has been tripped
          jeq	switchPress_3			; yes!
        cmp.w	#8,r5					; check if P2.3 has been tripped
...
;*******************************************************************************
;   Port 2 (switches) ISR
;	Turns off low power mode, moves the value of P2IFG into r5 which will be used
...
P2_ISR:
        ...
        mov.b	P2IFG,r5				; use r5 to save button press
        bic.w	#0xfff0,r5				; clear everything but the bottom four bits of r5
