...
*/
void QuickSort::sortAll(int data[], int size)
{
    throw std::runtime_error("QuickSort::sortAll not implemented");
}
...
*/
void QuickSort::sort(int data[], int size, int left, int right)
{
    throw std::runtime_error("QuickSort::sort not implemented");
}
...
*/
void QuickSort::medianOfThree(int data[], int size, int left, int right)
{
    throw std::runtime_error("QuickSort::medianOfThree not implemented");
}
...
*/
int QuickSort::partition(int data[], int size, int left, int right)
{
    throw std::runtime_error("QuickSort::partition not implemented");
}
...
* 		the second index
*/
void QuickSort::swap(int data[], int size, int i, int j)
{
    throw std::runtime_error("QuickSort::swap not implemented");
}
